...
public class Mavenproject3 {
    ...
    public static void main(String[] args) {
        ...
        String[] palabras = {"manzana", "banana", "pera", "naranja", "kiwi"};
...
public class Mavenproject2 {
    ...
    public static void agregarTarea(ArrayList<String> tareas, Scanner scan) {
    ...
    public static void mostrarTareas(ArrayList<String> tareas) {
        ...
        if (tareas.isEmpty()) {
            ...
            for (int i = 0; i < tareas.size(); i++) {
                System.out.println((+1) + ". " + tareas.get(i));
            }
        }

    }

    public static void completarTarea(ArrayList<String> tareas, Scanner scan) {
